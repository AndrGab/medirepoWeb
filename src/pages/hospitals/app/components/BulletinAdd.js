        ...
        <div className={classes.paper}>
          <Card className={classes.card}>
            ...
            <form
              ...
              noValidate
              onSubmit={handleRegisterBulletin}
            >
