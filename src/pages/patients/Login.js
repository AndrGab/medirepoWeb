      ...
      <Container component="main" maxWidth="xs">
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate onSubmit={handleLogin}>
            <TextField variant="outlined" margin="normal" required fullWidth id="cod_pac" label={t("patientCode")} name="cod_pac" autoFocus onChange={e => setCodpac(e.target.value)} /> <TextField variant="outlined" margin="normal" required fullWidth name="senha" label={t("password")} type="password" id="password" autoComplete="current-password" onChange={e => setPassword(e.target.value)} /> <TextField InputLabelProps={{ shrink: true }} variant="outlined" margin="normal" required fullWidth name="data_nasc" label={t("birthday")} type="date" id="data_nasc" autoComplete={t("birthday")} onChange={e => setDtnasc(e.target.value)} />
